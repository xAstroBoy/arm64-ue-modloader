...
bool is_game_thread() {
    if (!s_game_thread_id_set) return true;  // Before first PE call, assume game thread (boot)
...
void register_all(sol::state& lua) {
    ...
    lua.set_function("FindObjects", [](sol::this_state ts, sol::optional<int> num_to_find,
                                        const std::string& class_name,
                                        sol::optional<int> required_flags,
                                        sol::optional<int> banned_flags) -> sol::object {
        sol::state_view lua(ts);
    ...
    lua.set_function("RegisterKeyBindWithModifiers", [](int key_code, int modifiers,
    ...
    lua.set_function("RegisterBeginPlayPreHook", [](sol::function callback) -> uint64_t {
        return pe_hook::register_global_pre(
            [callback](ue::UObject* self, ue::UFunction* func, void* parms) -> bool {
                ...
                if (name != "ReceiveBeginPlay" && name != "BeginPlay") return false;
                lua_uobject::LuaUObject wrapped;
                wrapped.ptr = self;
                auto result = callback(wrapped);
                if (result.valid() && result.get_type() == sol::type::boolean) return result.get<bool>();
                return false;
            });
    });
    ...
    lua.set_function("RegisterBeginPlayPostHook", [](sol::function callback) -> uint64_t {
        return pe_hook::register_global_post(
            [callback](ue::UObject* self, ue::UFunction* func, void* parms) {
                if (!func) return;
                std::string name = reflection::get_short_name(reinterpret_cast<const ue::UObject*>(func));
                if (name != "ReceiveBeginPlay" && name != "BeginPlay") return;
                lua_uobject::LuaUObject wrapped;
                wrapped.ptr = self;
                auto result = callback(wrapped);
                if (!result.valid()) {
    ...
    lua.set_function("RegisterInitGameStatePreHook", [](sol::function callback) -> uint64_t {
        return pe_hook::register_global_pre(
            [callback](ue::UObject* self, ue::UFunction* func, void* parms) -> bool {
                if (!func) return false;
                std::string name = reflection::get_short_name(reinterpret_cast<const ue::UObject*>(func));
                if (name != "InitGameState") return false;
                lua_uobject::LuaUObject wrapped;
                wrapped.ptr = self;
                auto result = callback(wrapped);
                if (result.valid() && result.get_type() == sol::type::boolean) return result.get<bool>();
    ...
    lua.set_function("RegisterLoadMapPreHook", [](sol::function callback) -> uint64_t {
        return pe_hook::register_global_pre(
            [callback](ue::UObject* self, ue::UFunction* func, void* parms) -> bool {
                if (!func) return false;
                std::string name = reflection::get_short_name(reinterpret_cast<const ue::UObject*>(func));
                if (name != "LoadMap" && name != "ServerTravel") return false;
                lua_uobject::LuaUObject wrapped;
                wrapped.ptr = self;
                auto result = callback(wrapped);
                if (result.valid() && result.get_type() == sol::type::boolean) return result.get<bool>();
    ...
    lua.set_function("RegisterLoadMapPostHook", [](sol::function callback) -> uint64_t {
        return pe_hook::register_global_post(
            [callback](ue::UObject* self, ue::UFunction* func, void* parms) {
                if (!func) return;
                std::string name = reflection::get_short_name(reinterpret_cast<const ue::UObject*>(func));
                if (name != "LoadMap" && name != "ServerTravel") return;
                lua_uobject::LuaUObject wrapped;
                wrapped.ptr = self;
                callback(wrapped);
            });
    ...
    lua.set_function("RegisterProcessConsoleExecPreHook", [](sol::function callback) -> uint64_t {
        return pe_hook::register_global_pre(
            [callback](ue::UObject* self, ue::UFunction* func, void* parms) -> bool {
                if (!func) return false;
                std::string name = reflection::get_short_name(reinterpret_cast<const ue::UObject*>(func));
                if (name != "ProcessConsoleExec") return false;
                lua_uobject::LuaUObject wrapped;
                wrapped.ptr = self;
                auto result = callback(wrapped);
                if (result.valid() && result.get_type() == sol::type::boolean) return result.get<bool>();
    ...
    lua.set_function("RegisterProcessConsoleExecPostHook", [](sol::function callback) -> uint64_t {
        return pe_hook::register_global_post(
            [callback](ue::UObject* self, ue::UFunction* func, void* parms) {
                if (!func) return;
                std::string name = reflection::get_short_name(reinterpret_cast<const ue::UObject*>(func));
                if (name != "ProcessConsoleExec") return;
                lua_uobject::LuaUObject wrapped;
                wrapped.ptr = self;
                callback(wrapped);
            });
    ...
    lua.set_function("RegisterCallFunctionByNameWithArgumentsPreHook", [](sol::function callback) -> uint64_t {
        return pe_hook::register_global_pre(
            [callback](ue::UObject* self, ue::UFunction* func, void* parms) -> bool {
                if (!func) return false;
                std::string name = reflection::get_short_name(reinterpret_cast<const ue::UObject*>(func));
                if (name != "CallFunctionByNameWithArguments") return false;
                lua_uobject::LuaUObject wrapped;
                wrapped.ptr = self;
                auto result = callback(wrapped);
                if (result.valid() && result.get_type() == sol::type::boolean) return result.get<bool>();
    ...
    lua.set_function("RegisterCallFunctionByNameWithArgumentsPostHook", [](sol::function callback) -> uint64_t {
        return pe_hook::register_global_post(
            [callback](ue::UObject* self, ue::UFunction* func, void* parms) {
                if (!func) return;
                std::string name = reflection::get_short_name(reinterpret_cast<const ue::UObject*>(func));
                if (name != "CallFunctionByNameWithArguments") return;
                lua_uobject::LuaUObject wrapped;
                wrapped.ptr = self;
                callback(wrapped);
            });
    ...
    lua.set_function("RegisterULocalPlayerExecPreHook", [](sol::function callback) -> uint64_t {
        return pe_hook::register_global_pre(
            [callback](ue::UObject* self, ue::UFunction* func, void* parms) -> bool {
                ...
                if (cls_name.find("LocalPlayer") == std::string::npos) return false;
                lua_uobject::LuaUObject wrapped;
                wrapped.ptr = self;
                auto result = callback(wrapped);
                if (result.valid() && result.get_type() == sol::type::boolean) return result.get<bool>();
    ...
    lua.set_function("RegisterULocalPlayerExecPostHook", [](sol::function callback) -> uint64_t {
        return pe_hook::register_global_post(
            [callback](ue::UObject* self, ue::UFunction* func, void* parms) {
                ...
                if (!cls) return;
                std::string cls_name = reflection::get_short_name(reinterpret_cast<const ue::UObject*>(cls));
                if (cls_name.find("LocalPlayer") == std::string::npos) return;
                lua_uobject::LuaUObject wrapped;
                wrapped.ptr = self;
                callback(wrapped);
            });
    ...
    // 1) StaticFindObject(path) — already in lua_bindings.cpp
    // 2) StaticFindObject(class, outer, name, exactClass?)
    // We add the 2nd overload
    // ═══════════════════════════════════════════════════════════════════

    lua.set_function("StaticFindObjectEx", [](sol::this_state ts,
            sol::object cls_arg, sol::object outer_arg,
            const std::string& name, sol::optional<bool> exact) -> sol::object {
        sol::state_view lua(ts);
        if (!symbols::StaticFindObject) return sol::nil;

        ue::UClass* cls = nullptr;
        if (cls_arg.is<lua_uobject::LuaUObject>()) {
            cls = reinterpret_cast<ue::UClass*>(cls_arg.as<lua_uobject::LuaUObject&>().ptr);
        }

        ue::UObject* outer = nullptr;
        if (outer_arg.is<lua_uobject::LuaUObject>()) {
            outer = outer_arg.as<lua_uobject::LuaUObject&>().ptr;
        }

        std::wstring wname(name.begin(), name.end());
        ue::UObject* obj = symbols::StaticFindObject(cls, outer, wname.c_str(), exact.value_or(false));
        if (!obj) return sol::nil;
        return lua_uobject::wrap_or_nil(lua, obj);
    });
