...
// FName constructor — FName::Init(FName* out, const wchar_t* name, int32_t Number)
using FName_InitFn = void(*)(ue::FName* out, const wchar_t* name, int32_t number);
extern FName_InitFn FName_Init;

// FOutputDevice::Log — void FOutputDevice::Log(const wchar_t* msg)
using FOutputDevice_LogFn = void(*)(void* device, const wchar_t* msg);
